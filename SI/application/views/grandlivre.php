...
<div class="container mt-3">
  <div class="row">
    <form action="<?php echo (base_url('Grandlivre')); ?>" method="get">
            ...
            <tbody>
              <?php foreach ($operation['operation'] as $op) { ?>
                <tr>
                  ...
                  <th><a href="<?php echo base_url('Grandlivre/delete/' . $op['num_operation']); ?>"><button class="btn btn-danger">delete</button></a></th>
                </tr>
              <?php } ?>
            </tbody>
          </table>
