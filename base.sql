...
INSERT INTO COMPTE_PRODUIT_CENTRE (IDCOMPTE, IDCENTRE, POURCENTAGE, PRIXUNITE, QUANTITE, IDNATURE) VALUES
(37, 1, 0, 4321600, 1, 2),
(37, 2, 0, 4321600, 1, 2),
(37, 3, 100, 4321600, 1, 2),
(38, 1, 0, 60000000, 1, 2),
(38, 2, 0, 60000000, 1, 2),
(38, 3, 100, 60000000, 1, 2);

-- INSERT INTO PLAN_COMPTABLE (NUM_COMPTE, NOM_COMPTE) VALUES
-- (60120, 'ACHAT SEMENCE'),
-- (60110, 'ACHAT ENGRAIS&ASSIMILES'),
-- (60260, 'ACHAT EMBALLAGE'),
-- (32240, 'FOURNIT DE MAGASIN'),
-- (, 'FOURNIT BUR'),
-- (, 'PIECE RECH VEHICULES'),
...
-- (, 'SALAIRES M.O.TEMPORAIRES'),
-- (64110, 'SALAIRES PERMANENTS'),
-- (, 'CNAPS COTISATION PATRONALE'),
-- (, 'ORGANISME SANITAIRE'),
