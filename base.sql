...
CREATE TABLE IF NOT EXISTS PLAN_GENERAL(
	ID SERIAL PRIMARY KEY,
	INTITULE VARCHAR(35),
	DEBUT INT(5) UNIQUE NOT NULL,
	FIN INT(5) UNIQUE NOT NULL,
	REPORT TINYINT UNSIGNED DEFAULT 0,
	DEFAULT_TYPE TINYINT UNSIGNED DEFAULT 0,
	CHECK(FIN > DEBUT)
);
CREATE TABLE IF NOT EXISTS PLAN_COMPTABLE (
	ID SERIAL PRIMARY KEY,
	NUM_COMPTE INT(5) NOT NULL UNIQUE,
